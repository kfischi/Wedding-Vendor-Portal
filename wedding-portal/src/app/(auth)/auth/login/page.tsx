    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-cream-white rounded-2xl card-shadow gold-border p-8 sm:p-10">
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-xs text-stone/40">או</span>
          <div className="flex-1 h-px bg-champagne/60" />
        </div>
        ...
        <button
          ...
          className="
            w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg
            border border-champagne bg-white text-obsidian text-sm font-medium
            hover:bg-ivory active:scale-[0.99] transition-all duration-150
          "
        >
