...
// Unified sender address. Review/lead code may still import RESEND_FROM_EMAIL —
// kept as an alias to avoid import churn.
export const FROM_EMAIL =
  process.env.FROM_EMAIL ?? "WeddingPro <info@weddingpro.co.il>";
export const RESEND_FROM_EMAIL = process.env.RESEND_FROM_EMAIL ?? FROM_EMAIL;
